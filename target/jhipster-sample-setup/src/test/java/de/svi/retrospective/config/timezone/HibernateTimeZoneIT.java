package de.svi.retrospective.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import de.svi.retrospective.IntegrationTest;
import de.svi.retrospective.repository.timezone.DateTimeWrapper;
import de.svi.retrospective.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM svi_date_time_wrapper where id=%d", fieldName, id);
    }
